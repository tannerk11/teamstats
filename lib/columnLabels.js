...
export const COLUMN_LABELS = {
  ...
  ptspm: 'Points/Game',
  ptsopp: 'Opp Points',
  ptspgopp: 'Opp Points/Game',
  ptspmopp: 'Opp Points/Game',
  
  // Points Breakdown
  ptspaint: 'Points in Paint',
  ptspaintpg: 'Paint Points/Game',
  ptspaintopp: 'Opp Paint Points',
  ptspaintpgopp: 'Opp Paint Points/Game',
  ptsbench: 'Bench Points',
  ptsbenchpg: 'Bench Points/Game',
  ptsbenchopp: 'Opp Bench Points',
  ptsbenchpgopp: 'Opp Bench Points/Game',
  ptsfastb: 'Fast Break Points',
  ptsfastbpg: 'Fast Break/Game',
  ptsfastbopp: 'Opp Fast Break Points',
  ptsfastbpgopp: 'Opp Fast Break/Game',
  ptsto: 'Points Off Turnovers',
  ptstopg: 'Points Off TO/Game',
  ptstoopp: 'Opp Points Off TO',
  ptstopgopp: 'Opp Points Off TO/Game',
  ptsch2: '2nd Chance Points',
  ptsch2pg: '2nd Chance/Game',
  ptsch2opp: 'Opp 2nd Chance Points',
  ptsch2pgopp: 'Opp 2nd Chance/Game',
  ...
  // Rebounds
  treb: 'Total Rebounds',
  trebpg: 'Rebounds/Game',
  trebpm: 'Rebounds/Game',
  ...
  // Opponent Rebounds
  trebopp: 'Opp Total Rebounds',
  trebpgopp: 'Opp Rebounds/Game',
  trebpmopp: 'Opp Rebounds/Game',
  orebopp: 'Opp Off Rebounds',
  orebpgopp: 'Opp Off Reb/Game',
  orebpmopp: 'Opp Off Reb/Game',
  drebopp: 'Opp Def Rebounds',
  ...
  possessionsPerGame: 'Possessions/Game',
